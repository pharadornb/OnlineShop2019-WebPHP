...
?>
<html>
<head><title>สินค้าอุปโภคและบริโภค</title>
        ...
        ?>
			...
			<tr>
				<td colspan="3" align="center">
					<table border="0" align="left">
						<tr>
							<td colspan="3" align="left"><div class="c"><b><b>สินค้าประเภทอุปโภคและบริโภค : </b></b></div></td>
						</tr>
					</table><br /><br/><br/>
            ...
            <tr>
              ...
              <th>รูปภาพสินค้า</th>
						...
						<?php
						$sql="SELECT * FROM products WHERE product_catalog_id=2 AND product_stock > 0 ORDER BY product_code";
