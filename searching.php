        ...
        ?>
			...
			<tr>
				<td colspan="3" align="center">
					<table border="0" align="left">
						<tr>
							<td colspan="3" align="left"><div class="c"><b><b>ผลลัพธ์การค้นหา : </b></b></div></td>
						</tr>
					</table><br /><br/><br/>
            ...
            <tr>
              ...
              <th>รูปภาพสินค้า</th>
						...
						<?php
						$sql="SELECT * FROM products WHERE product_name LIKE '%" . $_POST["product_search"] . "%' AND product_stock > 0 ORDER BY product_code";
