	...
	<table border="0" align="center" bordercolor="grey" bgcolor="white" width="60%">
		...
		<tr>
			<td colspan="3" align="center">
				...
				<table border="0">
						<?php
							$sql=" SELECT u.image, u.user_id, u.username, u.name, u.surname, u.address, d.district_name, a.amphur_name, p.province_name, z.zipcode_name, u.tel_number, u.email FROM user_account u
							...
							while($product = mysqli_fetch_array($products)) {
								...
								<table border=0>
								<tr><td align='right'><b>ชื่อผู้ใช้: </b></td><td> <input type='text' align='center' size=15 name='goods_code' value= " . $product['username']. "> </td></tr>" .
								"<tr><td align='right'><b>ชื่อ: </b></td><td> <input type='text' align='center' size=15 name='goods_code' value=" . $product['name']. "> </td></tr>" .
								"<tr><td align='right'><b>ชื่อสกุล: </b></td><td> <input type='text' align='center' size=15 name='goods_code' value=" . $product['surname']. "> </td></tr>" .
								"<tr><td align='right' valign='top'><b>ที่อยู่ : </b></td><td> <textarea name='address' cols='30'>" . $product['address']. "</textarea> </td></tr>" .
								...
								"<tr><td align='center' colspan='2'>" . "<a href='user_edit.php?edit=$product[user_id]'>แก้ไขบัญชีผู้ใช้</a>" . "</td></tr>" .
								"</td></tr> ";
							}
						?>
				</table><br/ >
